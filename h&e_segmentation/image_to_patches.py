...
img = cv2.imread(os.path.join(local_dir,'train', 'images','image_0.png'))
gt = cv2.imread(os.path.join(local_dir,'gt', 'seg_0.png'))

savedir = os.path.join(local_dir,'patches_img_0')
